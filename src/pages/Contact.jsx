        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div data-aos="fade-up" data-aos-delay="200">
                ...
                <input
                  ...
                  {...register("name")}
                  className={`w-full bg-slate-800 border rounded-xl px-4 py-3 text-white text-sm outline-none transition ${
                    errors.name
                      ? "border-red-500"
              ...
              <div data-aos="fade-up" data-aos-delay="350">
                ...
                <textarea
                  ...
                  {...register("message")}
                  className={`w-full bg-slate-800 border rounded-xl px-4 py-3 text-white text-sm outline-none resize-none ${
                    errors.message
                      ? "border-red-500"
                      : "border-slate-700 focus:border-amber-400"
                  }`}
              ...
              <button
                ...
                className="w-full bg-amber-400 text-slate-950 py-3 rounded-xl font-semibold hover:bg-amber-300 transition"
              >
          ...
          <div className="space-y-6">
            ...
            <div
              data-aos="zoom-in"
              data-aos-delay="400"
              className="rounded-2xl overflow-hidden border border-slate-800 h-64"
            >
              <iframe
